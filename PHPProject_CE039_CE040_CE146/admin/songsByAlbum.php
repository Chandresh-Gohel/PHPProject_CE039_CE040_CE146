...
$song_album_id=$_REQUEST['album_id'];
$rowSpan = 0;
?>
<!-- ------------------------------------Start of Navbar------------------------------ -->
...
<?php
try{
      $sql_select=$con->prepare("SELECT * FROM album WHERE id='$song_album_id'");
      $sql_select->execute();
...
<div class="playlist_info">
            	<table  cellspacing="0">
                <tr>
                    	<td><img src="../admin/images/album/<?php echo$rowalbum['albumimage']; ?>" height="140px" width="130px"/><p class="text-center"><b>Cover Page</b></p></td>
                        <td>
                        	<table>
                            	<tr>
                                	<td id=album><b>Album:</b></td>
                                	<td><?php echo $rowalbum['albumname']?></td>
                                </tr>
                                <tr>
        ...
        <table class="table table-bordered text-center">
                ...
                <tbody>
                    <?php
                        try{
                          $getsong = $con->prepare("SELECT * FROM songs WHERE songalbum='$song_album_id' ");
                          $getsong->execute();
